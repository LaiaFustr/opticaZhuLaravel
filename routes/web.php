...
Route::post('/login-usuario', [UserController::class, 'login'])->name('login.custom');
...
/* Route::get('propietario/citas', function () {
    ...
    Route::post('/propietario/editarArticulo', [ArticuloController::class, 'editarArticulo'])->name("editarArticulo");
    Route::get("/propietario/borrarArticulo/{id}", [ArticuloController::class, 'borrarArticulo'])->name('borrarArticulo');
    ...
    Route::get("/propietario/borrarOptica/{id}", [OpticaController::class, 'borrarOptica'])->name('borrarOptica');
