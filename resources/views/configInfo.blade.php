...
<div class="container-flex containerPagina">
    <div class="row w-100 mb-4">
        ...
        <div class="row w-100">
                    ...
                    <div class="col px-2">
                        <div class="row my-3">
                            <div class="col mr-5">
                                ...
                                <input class="form-control form-control-lg" type="text" name="nombre" id="nombreO">
                            </div>

                            <div class="col">
                                <label class="col-form label" for="telefonoO">Teléfono</label>
                                <input class="form-control form-control-lg" type="tel" name="telefono" id="telefonoO">
                            </div>
                        ...
                        <div class="row my-2 mt-5">
                            <div class="col">
                                ...
                                <input class="form-control form-control-lg" type="text" name="direccion" id="direccionO">
                            </div>


                            <div class="col">
                                <label class="col-form label" for="correoO">Correo Electrónico</label>
                                <input class="form-control form-control-lg" type="email" name="correo" id="correoO">
                            </div>
                        ...
                        <div class="row my-2 mt-5">
                            <div class="col-6">
                                ...
                                <input class="form-control form-control-lg" type="number" name="num_Maquinas" id="numMaquina">
                            </div>
                        </div>
            ...
            <div class="col d-flex justify-content-end">
                <div class="card  mb-1">
                    <div class="card-header"><h5>Información de la Óptica</h5></div>
                    <div class="card-body">
                        <p class="card-text">Información básica de la óptica para poder identificarla.</p>
                    </div>
                </div>
            </div>
        </div>
