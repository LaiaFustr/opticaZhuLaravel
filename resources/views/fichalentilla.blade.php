...
<div class="container-flex containerPagina">
    ...
    <form class="" action="{{route('creaFicha')}}" method="post">
        ...
        <div class="row">
            ...
            <div class="dropdown col" id="apartadosFichaDrodown">
                ...
                <ul class="dropdown-menu unstyled-list p-2" id="checksFicha">
                    ...
                    <li>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="superficieOcularCheck" id="superficieOcularCheck">
                            <label class="form-check-label" for="superficieOcularCheck">Superficie Ocular</label>
                        </div>
                    </li>
                    <li>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="parametrosCheck" id="parametrosCheck">
                            <label class="form-check-label" for="parametrosCheck">Parametros</label>
                        </div>
                    </li>
                    <li>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="usoPrevistoCheck" id="usoPrevistoCheck">
                            <label class="form-check-label" for="usoPrevisto">Uso Previsto</label>
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <div class="row my-1">
                    <div class="col col-9 border-end">
                        ...
                        <div class="row d-flex align-items-center my-1">
                            ...
                            <div class="col col-auto"> <label for="">Corr. :</label></div>
                            <div class="col col-2">
                                <input class="form-control form-control-sm" name="avbinoc[corr_oi]" type="text" id="bncorr_oi">
                            </div>
                        </div>
                    </div>
                    <div class="col-3 d-flex align-items-center">
        ...
        <div class="row card p-1 my-1 cardFicha" id="superficieOcular" style="display:none">
            <div class="col">
                <div class="row">
                    <h4>Superficie Ocular</h4>
                </div>
                <div class="row my-1">
                    <div class="row d-flex align-items-center my-1">
                        <div class="col col-2"><label for="">OJO DERECHO</label></div>
                        ...
                        <div class="col col-auto"> <label for="">Cornea:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="superficie[cornea_od]" type="text" id="cornea_od">
                        </div>
                        <div class="col col-auto"> <label for="">Parpados:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="superficie[parpados_od]" type="text" id="parpado_od">
                        </div>
                        <div class="col col-auto"> <label for="">Tincion:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="superficie[tincion_od]" type="text" id="tincion_od">
                        </div>
                    </div>
                    <div class="row d-flex align-items-center my-1">
                        <div class="col col-2"> <label for="">OJO IZQUIERDO</label></div>
                        ...
                        <div class="col col-auto"> <label for="">Cornea:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="superficie[cornea_oi]" type="text" id="cornea_oi">
                        </div>
                        <div class="col col-auto"> <label for="">Parpados:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="superficie[parpados_oi]" type="text" id="parpado_oi">
                        </div>
                        <div class="col col-auto"> <label for="">Tincion:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="superficie[tincion_oi]" type="text" id="tincion_oi">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row card p-1 my-1 cardFicha" id="parametros" style="display:none">
            <div class="col">
                <div class="row">
                    <h4>Parametros</h4>
                </div>
                <div class="row my-1">
                    <div class="row d-flex align-items-center my-1">
                        ...
                        <div class="col col-auto"> <label for="">Curva Base:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="parametros[curvabase_od]" type="text" id="curvabase_od">
                        </div>
                        <div class="col col-auto"> <label for="">Diametro:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="parametros[diametro_od]" type="text" id="diametro_od">
                        </div>
                        <div class="col col-auto"> <label for="">Potencia:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="parametros[potencia_od]" type="text" id="potencia_od">
                        </div>
                        <div class="col col-auto"> <label for="">Eje:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="parametros[eje_od]" type="text" id="eje_od">
                        </div>
                    </div>
                    <div class="row d-flex align-items-center my-1">
                        <div class="col col-2"> <label for="">OJO IZQUIERDO</label></div>
                        ...
                        <div class="col col-auto"> <label for="">Curva Base:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="parametros[curvabase_oi]" type="text" id="curvabase_oi">
                        </div>
                        <div class="col col-auto"> <label for="">Diametro:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="parametros[diametro_oi]" type="text" id="diametro_oi">
                        </div>
                        <div class="col col-auto"> <label for="">Potencia:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="parametros[potencia_oi]" type="text" id="potencia_oi">
                        </div>
                        <div class="col col-auto"> <label for="">Eje:</label></div>
                        <div class="col col-2">
                            <input class="form-control form-control-sm" name="parametros[eje_oi]" type="text" id="eje_od">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row  my-1 row-auto">
            <div class="col card p-1 cardFicha col-auto me-auto" id="usoPrevisto" style="display:none">
                <div class="row">
                    <h4>Uso previsto</h4>
                </div>
                <div class="row m-1">
                    <div class="col-auto form-check">
                        <label class="form-label" for="tiempodeuso">Tiempo de uso</label>
                        <select class="form-select" name="tiempodeuso">
                    ...
                    <div class="col-auto form-check">
                        <label class="form-label" for="usodiarias">Horas de uso diarias</label>    
                        <input class="form-control" name="usodiarias" type="number" id="usodiarias" min="0" max="24">
                    </div>
                </div>
            </div>
        </div>
